<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="ManageUsers.aspx.cs" Inherits="BBMS.ManageUsers" %>
...
<div class="dash-wrapper theme-admin">
    ...
    <div class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="ManageUsers.aspx" class="active"><i class="bi bi-people"></i> Manage Users</a></li>
    ...
    <div class="main-content">
        ...
        <div style="background:#fff; border-radius:14px; padding:20px; box-shadow:0 3px 10px rgba(0,0,0,.05);">
            ...
            <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:18px;">
                <input type="text" placeholder="Search users..." style="padding:9px 14px; border:1px solid #e5e7eb; border-radius:8px; width:260px;" />
                    ...
                    <asp:Repeater ID="rptUsers" runat="server">
                        <ItemTemplate>
                            <tr style="border-bottom:1px solid #f4f5f7;">
                                ...
                                <td style="padding:12px;"><%# Eval("Email") %></td>
                                <td style="padding:12px;"><%# Eval("Phone") %></td>
                                <td style="padding:12px;">
                                    <span style="background:#dcf5e3; color:#16a34a; padding:4px 10px; border-radius:20px; font-size:12px; font-weight:600;"><%# Eval("Status") %></span>
                                </td>
                                <td style="padding:12px;">

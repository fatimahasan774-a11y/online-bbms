...
<div class="dash-wrapper theme-donor">
    ...
    <div class="main-content">
        <div class="topbar">
            <h3>View Donation Eligibility</h3>
        ...
        <div style="background:#fff; border-radius:14px; padding:30px; box-shadow:0 3px 10px rgba(0,0,0,.05); max-width:560px; text-align:center;">
            ...
            <div style="display:flex; justify-content:space-between; text-align:left; background:#f3f5fa; border-radius:10px; padding:14px 18px;">
                ...
                <div>
                    ...
                    <div style="font-weight:700; color:#3a1f5d;">≥ 50kg</div>
                </div>
                <div>
                    <div style="font-size:12px; color:#6b7280;">Age Requirement</div>
                    <div style="font-weight:700; color:#3a1f5d;">18-60</div>
                </div>
            </div>

            <a href="DonateBlood.aspx" style="display:inline-block; margin-top:20px; background:#3a1f5d; color:#fff; padding:11px 26px; border-radius:8px; font-weight:600; text-decoration:none;">
                Book a Donation
            </a>
        </div>
    </div>

...
<div class="dash-wrapper theme-user">
    ...
    <div class="main-content">
        ...
        <div class="stats-row">
            ...
            <div class="stat-card">
                ...
                <div>
                    <h4><asp:Label ID="lblDonorStatus" runat="server" Text="Not a Donor"></asp:Label></h4>
                    <asp:HyperLink ID="lnkDonorAction" runat="server" NavigateUrl="RegisterAsDonor.aspx" class="link" style="color:#dc2626; font-weight:700;">Register Now</asp:HyperLink>
                </div>
            </div>
        </div>
    ...
    <div class="qa-title">Quick Access</div>
     <div class="quick-access">
        ...
        <a href="Login.aspx" class="qa-card" style="text-decoration:none;">

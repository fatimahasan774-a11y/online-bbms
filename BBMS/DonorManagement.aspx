<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="DonorManagement.aspx.cs" Inherits="BBMS.DonorManagement" %>
            ...
            <table style="width:100%; border-collapse:collapse; font-size:14px;">
                <thead>
                    <tr style="text-align:left; color:#6b7280; border-bottom:1px solid #eef0f4;">
                        ...
                        <th style="padding:10px;">Last Donation</th>
                    ...
                    <asp:Repeater ID="rptDonors" runat="server">
                        <ItemTemplate>
                            <tr style="border-bottom:1px solid #f4f5f7;">
                                ...
                                <td style="padding:12px; font-weight:600;"><%# Eval("FullName") %></td>
                                <td style="padding:12px;">
                                    <span style="background:#fde0e0; color:#e11d48; padding:4px 10px; border-radius:20px; font-size:12px; font-weight:700;"><%# Eval("BloodGroup") %></span>
                                </td>
                                <td style="padding:12px;"><%# Eval("LastDonation") %></td>
                                <td style="padding:12px;">
                                    <span style='background:<%# (bool)Eval("Eligible") ? "#dcf5e3" : "#fdf1d0" %>; color:<%# (bool)Eval("Eligible") ? "#16a34a" : "#d97706" %>; padding:4px 10px; border-radius:20px; font-size:12px; font-weight:600;'>
                                        <%# (bool)Eval("Eligible") ? "Eligible" : "Not Yet" %>
                                    </span>
                                </td>
                                <td style="padding:12px;">
                                    <a href="#" style="color:#2563eb; margin-right:10px;"><i class="bi bi-eye"></i></a>

<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="ApproveRejectRequests.aspx.cs" Inherits="BBMS.ApproveRejectRequests" %>
...
<div class="dash-wrapper theme-admin">
    ...
    <div class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="ApproveRejectRequests.aspx" class="active"><i class="bi bi-check2-square"></i> Approve/Reject Requests</a></li>
    ...
    <div class="main-content">
        ...
        <asp:Label ID="lblMsg" runat="server" style="display:block; margin-bottom:14px; font-weight:600;" />
                    ...
                    <asp:Repeater ID="rptPending" runat="server" OnItemCommand="rptPending_ItemCommand">
                        <ItemTemplate>
                            <tr style="border-bottom:1px solid #f4f5f7;">
                                ...
                                <td style="padding:12px; font-weight:600;"><%# Eval("Requester") %></td>
                                ...
                                <td style="padding:12px;">
                                    <asp:LinkButton runat="server" CommandName="Approve" CommandArgument='<%# Eval("Id") %>'
                                        style="color:#16a34a; margin-right:10px; text-decoration:none; font-weight:600;">
                                        <i class="bi bi-check-circle"></i> Approve
                                    </asp:LinkButton>
                                    <asp:LinkButton runat="server" CommandName="Reject" CommandArgument='<%# Eval("Id") %>'

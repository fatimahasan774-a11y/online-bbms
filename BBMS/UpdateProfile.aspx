<%@ Page Title="" Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeBehind="UpdateProfile.aspx.cs" Inherits="BBMS.UpdateProfile" %>
...
<div class="dash-wrapper theme-user">
    ...
    <div class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="UpdateProfile.aspx" class="active"><i class="bi bi-person"></i> Update Profile</a></li>
    ...
    <div class="main-content">
        ...
        <div style="background:#fff; border-radius:14px; padding:24px; box-shadow:0 3px 10px rgba(0,0,0,.05); max-width:560px;">
            ...
            <div style="margin-bottom:14px;">
                ...
                <asp:TextBox ID="txtName" runat="server" Text="User Name" style="width:100%; padding:9px; border:1px solid #e5e7eb; border-radius:8px; margin-top:5px;" />
            </div>

            <div style="margin-bottom:14px;">
                <label style="font-size:13px; font-weight:600; color:#6b7280;">Email</label><br />
                <asp:TextBox ID="txtEmail" runat="server" Text="user@example.com" style="width:100%; padding:9px; border:1px solid #e5e7eb; border-radius:8px; margin-top:5px;" />
            </div>

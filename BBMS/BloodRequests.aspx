<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="BloodRequests.aspx.cs" Inherits="BBMS.BloodRequests" %>
...
<div class="dash-wrapper theme-admin">
    ...
    <div class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="BloodRequests.aspx" class="active"><i class="bi bi-clipboard-data"></i> View Blood Requests</a></li>
